    ...
    data: function () {
      return {
        A: {
          ...
          message: `저의 동료 국민 여러분, ......(지면관계상 생략)`
        },
        B: {
          header: '버니샌더스 경선 패배 연설문',
          footer: '2017.07.25 - 필라델피아 웰스파고',
          message: `감사합니다. 여러분 정말 감사합니다. ......(지면관계상 생략)`
        }
      }
    }
  }
...
<style>
  .sanders {backgroun-color:antiquewhite;}
  .sanders-content {font-fammily:굴림;text-decoration:underline;}
</style>
