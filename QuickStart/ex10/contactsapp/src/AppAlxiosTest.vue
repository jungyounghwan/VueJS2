  ...
  export default {
    ...
    methods: {
      fetchContacts: function () {
        axios.get('/api/contacts', { //axios.get('/api/contacts', { 와 동일
...
<style>
  ...
  .container {border:1px solid gray;padding:10px;margin-bottom:10px;text-align:left;}
  #result {text-align:left;padding:20px;border:1px solid black;}
  .form-group {border:1px solid gray;padding:5px 5px 5px 20px;}
</style>
